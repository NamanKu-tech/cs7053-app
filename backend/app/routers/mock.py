...
_GRADING_PROMPT = (
    "You are a strict exam grader for a graduate-level Security & Privacy course at Trinity College Dublin (CS7053).\n\n"
    ...
    "Be strict: vague, surface-level answers that gesture at the right ideas without demonstrating real understanding should score 4-6. "
    "Missing key concepts from the grading guide must cost marks — do not give benefit of the doubt for implied understanding. "
    "A score of 7+ requires the student to have explicitly covered most of the grading guide's criteria with sufficient technical depth. "
    "A score of 9-10 requires near-complete coverage with correct terminology and concrete detail.\n\n"
    "Your feedback must be detailed and cover ALL of the following:\n"
    "1. What the student did well — name specific concepts or points they got right\n"
    "2. Which key concepts from the grading guide were missing, vague, or underdeveloped — be specific\n"
    "3. Why each gap costs marks — connect missing points to the grading criteria\n"
    "4. Concrete, actionable advice for the next attempt — name exactly what to add, what depth to go into, and what terminology to use\n\n"
    'Return JSON only with no markdown fences: {{"score": <integer 0-10>, "feedback": "<detailed feedback covering all 4 points, minimum 8 sentences>"}}\n\n'
